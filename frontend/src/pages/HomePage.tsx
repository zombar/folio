...
export default function HomePage() {
  ...
  if (error) {
    return (
      <div className="text-neutral-700 dark:text-neutral-300 p-4 bg-neutral-200 dark:bg-neutral-800 rounded-lg border border-neutral-300 dark:border-neutral-600">
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-neutral-900 dark:text-white">Portfolios</h1>
      ...
      {portfolios?.length === 0 ? (
        <div className="text-center py-16">
          ...
          <h2 className="text-lg font-medium text-neutral-700 dark:text-neutral-300 mb-2">No portfolios yet</h2>
          <p className="text-neutral-500 mb-4">Create your first portfolio to start generating images</p>
