...
export const TransformViewport = forwardRef<TransformViewportHandle, TransformViewportProps>(function TransformViewport({
  ...
  return (
    ...
    >
      ...
      {showNavigation && onPrev && onNext && (
        <>
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 p-3 bg-neutral-900/50 hover:bg-neutral-900/70 text-white rounded-full border border-white/20 shadow-lg transition-colors z-10"
          ...
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 p-3 bg-neutral-900/50 hover:bg-neutral-900/70 text-white rounded-full border border-white/20 shadow-lg transition-colors z-10"
      ...
      {showZoomControls && (
        <div className="absolute top-4 left-4 flex items-center gap-1.5 bg-neutral-900/50 backdrop-blur-sm p-2 border border-white/20 shadow-lg z-10">
