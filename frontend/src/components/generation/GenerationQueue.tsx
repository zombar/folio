...
export default function GenerationQueue({ generations }: GenerationQueueProps) {
  ...
  return (
    <div className="fixed bottom-4 right-4 w-80 bg-white dark:bg-neutral-800 rounded-lg shadow-xl border border-neutral-200 dark:border-neutral-700 overflow-hidden z-40">
